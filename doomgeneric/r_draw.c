...
// Flag to distinguish wall drawing from sprite drawing
...
int perf_drawspan_count = 0;
int perf_drawspan_pixels = 0;
...
void R_DrawColumn(void)
{
    ...
    // (We don't strictly need 'dest' for hardware, but keep it to not break logic)
    ...
    // ---------------------------------------------------------
    // [[ UNIFIED BUFFER RENDERING ]]
    // All rendering (walls, sprites, etc.) goes to I_VideoBuffer (320x200)
